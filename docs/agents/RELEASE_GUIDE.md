...
1. **GitHub Releases** - Pre-built binaries generated by `.github/workflows/release.yml`
...
- The install script is intentionally release-driven; it should resolve a tarball from GitHub Releases instead of building locally.
